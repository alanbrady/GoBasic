...
**
** Created: Mon Jul 9 18:28:41 2012
...
static const char qt_meta_stringdata_GameBoardWidget[] = {
    "GameBoardWidget\0\0size\0sizeChanged(QSize)\0"
};
...
const QMetaObjectExtraData GameBoardWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GameBoardWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GameBoardWidget,
      qt_meta_data_GameBoardWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GameBoardWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameBoardWidget))
